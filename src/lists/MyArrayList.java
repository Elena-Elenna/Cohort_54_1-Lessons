...
public class MyArrayList<T> {
    ...
    // 4. Удаление элемента по индексу (Если индекс есть - удалит элемент - вернет удаленное значение)
    ...
    // 11. Удаление элемента по значению (Если значение есть - удалит элемент - вернет true)
